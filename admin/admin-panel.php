<?php
    ...
    if(isset($_POST['login'])){
        if($_POST['uname'] == 'dwarkesh' && $_POST['pass'] == 'dwarkesh@1910'){
             $_SESSION['admin'] = 'dwarkesh';  
        }
        else{
       ...
       <div class="card text-center">
          <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
              ...
              <!-- <li class="nav-item">
                <a class="nav-link" href="./view_banquet_menu_plan.php">View Plans</a>
              </li> -->
              <li class="nav-item">
                  <a class="nav-link" href="./view_banquet_menu_plan.php">View Banquet Menu Plan</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="./banquet_book.php"  >Book Banquet</a>
              </li>
              <li class="nav-item">
