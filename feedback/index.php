...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>Feedback Form - Dwarkesh Restaurant and Banquet</title>
				...
				<div class="col-lg-12">
					<form id="contactForm" method="post" action="#">
						<div class="row">
							...
							<div class="col-md-12 p-2">
								<div class="form-group">
									<span class="field-title" style="font-size:26px"> Your Review for Dwarkesh Restaurant & Banquet</span>
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<div class="overflow-hidden">
						<h4>Location</h4>
						<p class="lead">
							Dwarkesh Restaurant, Mota bajar , Vidhyanagar, Anand.
						</p>
					</div>
				</div>
			</div>
	...
	<footer class="footer-area bg-f">
		<div class="container">
			<div class="row">
				<div class="col-lg-4 col-md-6">
					...
					<span style="padding:8px">'Trio The Vision' Group </span>
					</p>
				...
				<div class="col-lg-4 col-md-6">
					...
					<p class="lead">Dwarkesh Restaurant, Mota bajar, Vidhyanagar, Anand, Gujarat </p>
					<p class="lead"><a href="tel:8469000683">9876543210,</a> &nbsp;<a href="tel:8128141047">9876543210</a></p>
					<p><a href="mailto:restaurantdwarkesh@gmail.com"> restaurantdwarkesh@gmail.com</a></p>
				</div>
				<div class="col-lg-4 col-md-6">
					<h3>Opening hours</h3>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p class="company-name">Rights Reserved. &copy; 2023 <a href="./index.html">&nbsp;Dwarkesh Restaurant & Banquet</a> <br>Managed By 'Trio The Vision' Group</p>
					</div>
				</div>
			</div>
		</div>
